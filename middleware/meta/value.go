...
func GetValue(ctx context.Context, key string) (string, error) {
	...
	return "", api.ErrorBadRequest("获取元数据失败")
}
...
func GetIntValue(ctx context.Context, key string) (int, error) {
	...
	if err != nil {
		return 0, api.ErrorBadRequest("获取元数据 %s 转换为 int 失败", key)
	}
	return i, nil
}
...
func GetInt8Value(ctx context.Context, key string) (int8, error) {
	...
	if err != nil {
		return 0, api.ErrorBadRequest("获取元数据 %s 转换为 int8 失败", key)
	}
	return int8(i), nil
}
...
func GetInt16Value(ctx context.Context, key string) (int16, error) {
	...
	if err != nil {
		return 0, api.ErrorBadRequest("获取元数据 %s 转换为 int16 失败", key)
	}
	return int16(i), nil
}
...
func GetInt32Value(ctx context.Context, key string) (int32, error) {
	...
	if err != nil {
		return 0, api.ErrorBadRequest("获取元数据 %s 转换为 int32 失败", key)
	}
	return int32(i), nil
}
...
func GetInt64Value(ctx context.Context, key string) (int64, error) {
	...
	if err != nil {
		return 0, api.ErrorBadRequest("获取元数据 %s 转换为 int64 失败", key)
	}
	return i, nil
}
